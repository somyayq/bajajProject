...
5. **To Check is API is Working**
    ...
    https://bajaj-project-lemon.vercel.app/bfhl   (and check the post requests accodingly for fibonacci , hcf , lcm , prime and AI ) by inseting the content in the body as given above)
   ```
